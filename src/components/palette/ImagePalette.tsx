    ...
    <div className="relative shrink-0 hidden sm:block">
      ...
      <Tooltip text="Extract from image">
        <button
          onClick={handleClick}
          disabled={loading}
          className="flex items-center gap-1.5 h-10 px-4 rounded-full text-[14px] font-medium hover:bg-gray-100 hover:text-gray-700 transition-all disabled:opacity-50"
          style={{ color: '#555555' }}
        >
